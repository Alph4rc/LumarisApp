...
class TomorrowCoursesWidgetProvider : AppWidgetProvider() {
    ...
    private fun updateCourseList(
        ...
        if (courses.isEmpty()) {
            ...
            intent.data =
                Uri.parse("widget://tomorrow_courses?type=" + type + "&appWidgetId=" + appWidgetId)
    ...
    private fun getCurrentDate(): String {
        ...
        return "第${(calendar.get(Calendar.WEEK_OF_YEAR) % 20) + 1}周 周${
