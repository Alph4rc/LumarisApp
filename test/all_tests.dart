...
import 'unit/course_repository_test.dart' as course_repository_test;
import 'unit/score_repository_test.dart' as score_repository_test;
...
void main() {
  ...
  course_repository_test.main();
  score_repository_test.main();
